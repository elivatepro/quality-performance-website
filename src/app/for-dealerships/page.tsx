...
export default function ForDealerships() {
  return (
    <>
      {/* Hero */}
      <section className="relative flex min-h-[85vh] items-center bg-dark">
        ...
        <div className="relative mx-auto w-full max-w-[1280px] px-6 py-32 lg:px-12">
          <div className="max-w-2xl">
            <p className="animate-hero text-sm font-semibold uppercase tracking-wider text-primary">
              For Dealerships
            </p>
            <h1
              ...
              <div className="overflow-hidden rounded-xl bg-dark-alt p-2 shadow-elevated">
                ...
                <div className="rounded-lg bg-dark p-6">
                  ...
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <div className="rounded bg-primary/20 px-2 py-1 text-xs text-primary">Live</div>
                  </div>
                  ...
                  <div className="mt-4 space-y-2">
                    {[
                      ...
                      { vin: "•••2217", status: "Scheduled", color: "text-primary" },
                    ].map((install) => (
